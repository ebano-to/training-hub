...
const WEEK_ARCHIVE = [
  ...
  { id: 'S29', label: 'S29 · 13 LUG → 19 LUG', range: '13 LUG → 19 LUG 2026', programWeek: 29, days: [
...
const WEEK = [
  { day: 'LUN', date: '20', title: 'BIKE TEST (Gabri) + ROW/SKI WAVE FARTLEK (Mattia)', sub: 'test bici (20/07) + wave fartlek erg (21/07)', load: 'Z1-Z5', duration: 145, kind: 'hyrox', done: true,
    blocks: [
      ...
      { code: 'ROW', t: 'casa · Row+Ski Wave Fartlek · 13×(3\'Z2/2\'Z1)', d: '10\' risc Z1\n13×(3\' Z2 / 2\' Z1) in onde regolari\nALTERNA 2 waves Ski, 2 waves Row\n10\' defa Z1\nZ1 110-119 bpm · Z2 120-135 bpm (lattato)', dur: '~85\'',
        ...
        result: 'FATTO (21/07) · 15.892km ~70\' continui · ROW 9.223km + SKI 6.669km · WU 5\' row + 13 onde 3\'Z2/2\'Z1 (alterna 2row/2ski, blocchi da 10\') · +1 onda vs 14/07 (13 vs 12) · HR 121/144 · ONDE 3\' (devono essere Z2): 12/13 in Z2 (120-127), solo la 1ª ski a 116.6 (FC crollata a ~92 nel cambio row→ski, risale a 125 a fine onda = artefatto transizione, non intensità) · REC 2\' (devono essere Z1): quasi tutti Z1 (111-118) ma 3-4 restano a 120-121 (FC non scende in Z1, soprattutto ski centrale) · watt onde (lap PM5): ROW 194-207W · SKI 164-178W (cala 178→170→164 = decoupling ski) · EF row ~1.62 ski ~1.42 · NESSUN recupero tra blocchi (gap 0-60s, solo riaccensione macchina) · vs 14/07: HR 121 identica, row uguale, ski un filo più basso' },
    ]
  },
  ...
  { day: 'MER', date: '22', title: 'RUN 13KM (Gabri) + ASSAULT 85\' (Mattia)', sub: 'medio 13km + assault pyramid · pesi spostati a VEN 24', load: 'Z2', duration: 155, kind: 'hyrox', runKm: 13, done: false,
    blocks: [
      ...
      { code: 'BIKE', t: 'casa · Assault Bike Intra-Session Pyramid · 85\'', d: '5\' rampa Z1→Z2\n15\' Z2 low (120-125 bpm)\n15\' Z2 mid (125-130 bpm)\n20\' Z2 top (130-135 bpm)\n15\' Z2 mid (125-130 bpm)\n15\' Z2 low (120-125 bpm)\nZone lattato reali (Z2 120-135, FCmax 177) · km non contati', dur: '~85\'',
...
const HISTORY = [
  { date: '22 LUG', title: 'Assault Bike Pyramid 85\' · 268W avg · HR Z2 76%', kind: 'bike', dur: 85, load: 'Z2', rpe: 6, note: '1:24:59 · 50798m · 268W avg (392 max) · 58rpm · 35.9km/h · 987cal · HR 123.4/139 (display max 199 = artefatto, max reale 139) · km NON contati (assault) · piramide Z2 pbp: rampa96 low121.7 mid127.8 TOP132.5 mid127.7 low120.5 · Z2 76% Z1 12% Z3 3% · EF 2.17 · vs 15/07 (253W HR121.7 EF2.08): stesso profilo FC ma +15W +2rpm +816m a pari cuore = guadagno di efficienza aerobica · potenza dalla console Assault, HR point-by-point dal FIT Garmin' },
  { date: '21 LUG', title: 'Row+Ski Wave Fartlek · 15.892m · 13×(3\'Z2/2\'Z1) alterna 2row/2ski', kind: 'row', dur: 70, load: 'Z2', rpe: 5, note: '15.892km ~70\' continui · ROW 9.223km + SKI 6.669km · WU 5\' row + 13 onde (3\'Z2/2\'Z1) alterna 2row/2ski, a blocchi da 10\' · +1 onda vs 14/07 (13 vs 12) · ordinati 17:10→18:24 da 8 FIT · HR 121/144 · ONDE 3\' (target Z2): 12/13 in Z2 (120-127 bpm), solo la 1ª ski 116.6 (FC scesa a ~92 nel cambio row→ski, risale a 125 a fine onda = artefatto della transizione) · REC 2\' (target Z1): quasi tutti Z1 (111-118) ma 3-4 restano a 120-121 (FC non scende in Z1, soprattutto blocco ski centrale — oscillazione onda più stretta del voluto) · watt onde (avg_power lap FIT = PM5): ROW 194-207W · SKI 164-178W (cala 178→170→164 a pari FC = decoupling ski) · rec Z1 76-105W · EF onde row ~1.62 · ski ~1.42 · NESSUN recupero tra blocchi (gap 0-60s, solo riaccensione macchina) · vs 14/07: HR 121 identica, row uguale (~198W), ski un filo più basso e calante' },
...
// ── RECOVERY — dati Garmin (HRV, RHR, sonno, carico, readiness). Aggiornato ogni mattina alle 09:00. ──
const RECOVERY = {
  updated: '2026-07-21',
  baseline: { hrv: 72, rhr: 45, sleepNeedMin: 527 },
  today: { date: '21 LUG', readiness: 87, verdict: 'steady', recovery: 62, hrv: 73, rhr: 43, sleepMin: 524, sleepScore: 97, tsb: 13.3, ctl: 67.9, acwr: 1.03, monotony: 1.17, sleepDebtMin: 213 },
  days: [
    { date: '06-21', hrv: 91, rhr: 39, sleepMin: 501, sleepScore: 96, recovery: 59, load: null, tsb: null },
    { date: '06-22', hrv: 92, rhr: 39, sleepMin: 527, sleepScore: 98, recovery: 60, load: 285, tsb: -25.2 },
    { date: '06-23', hrv: 54, rhr: 46, sleepMin: 550, sleepScore: 84, recovery: 56, load: null, tsb: -12.4 },
    { date: '06-24', hrv: 72, rhr: 43, sleepMin: 543, sleepScore: 86, recovery: 56, load: 114, tsb: -15.1 },
    { date: '06-25', hrv: 96, rhr: 41, sleepMin: 504, sleepScore: 95, recovery: 59, load: 166, tsb: -23.5 },
    { date: '06-26', hrv: 65, rhr: 46, sleepMin: 559, sleepScore: 82, recovery: 55, load: null, tsb: -10.8 },
    { date: '06-27', hrv: 67, rhr: 46, sleepMin: 570, sleepScore: 85, recovery: 56, load: 110, tsb: -13.2 },
    { date: '06-28', hrv: 63, rhr: 47, sleepMin: 565, sleepScore: 76, recovery: 28, load: null, tsb: -2 },
    { date: '06-29', hrv: 72, rhr: 44, sleepMin: 453, sleepScore: 100, recovery: 55, load: null, tsb: 7.3 },
    { date: '06-30', hrv: 69, rhr: 46, sleepMin: 498, sleepScore: 85, recovery: 42, load: 115, tsb: 1.4 },
    { date: '07-01', hrv: 68, rhr: 46, sleepMin: 522, sleepScore: 86, recovery: 42, load: null, tsb: 10.2 },
    { date: '07-02', hrv: 55, rhr: 49, sleepMin: 252, sleepScore: 44, recovery: 3, load: 56, tsb: 10.7 },
    { date: '07-03', hrv: 67, rhr: 44, sleepMin: 527, sleepScore: 95, recovery: 52, load: 12, tsb: 16.5 },
    { date: '07-04', hrv: 76, rhr: 45, sleepMin: 555, sleepScore: 97, recovery: 60, load: 116, tsb: 8.8 },
    { date: '07-05', hrv: 50, rhr: 48, sleepMin: 448, sleepScore: 75, recovery: 13, load: 45, tsb: 10.9 },
    { date: '07-06', hrv: 73, rhr: 45, sleepMin: 541, sleepScore: 88, recovery: 56, load: 99, tsb: 6.1 },
    { date: '07-07', hrv: 60, rhr: 46, sleepMin: 530, sleepScore: 90, recovery: 39, load: 65, tsb: 6.1 },
    { date: '07-08', hrv: 76, rhr: 43, sleepMin: 498, sleepScore: 92, recovery: 69, load: 110, tsb: 0.7 },
    { date: '07-09', hrv: 76, rhr: 46, sleepMin: 342, sleepScore: 74, recovery: 51, load: 64, tsb: 1.8 },
    { date: '07-10', hrv: 71, rhr: 45, sleepMin: 484, sleepScore: 100, recovery: 55, load: 17, tsb: 8.1 },
    { date: '07-11', hrv: 74, rhr: 46, sleepMin: 344, sleepScore: 71, recovery: 46, load: null, tsb: 15.5 },
    { date: '07-12', hrv: 74, rhr: 45, sleepMin: 473, sleepScore: 90, recovery: 55, load: 96, tsb: 10.2 },
    { date: '07-13', hrv: 82, rhr: 45, sleepMin: 428, sleepScore: 86, recovery: 64, load: null, tsb: 17.1 },
    { date: '07-14', hrv: 78, rhr: 43, sleepMin: 449, sleepScore: 81, recovery: 64, load: 75, tsb: 14 },
    { date: '07-15', hrv: 67, rhr: 45, sleepMin: 427, sleepScore: 80, recovery: 41, load: 137, tsb: 3.8 },
    { date: '07-16', hrv: 78, rhr: 44, sleepMin: 434, sleepScore: 91, recovery: 64, load: 64, tsb: 4.1 },
    { date: '07-17', hrv: 72, rhr: 45, sleepMin: 485, sleepScore: 89, recovery: 50, load: null, tsb: 12 },
    { date: '07-18', hrv: 74, rhr: 44, sleepMin: 550, sleepScore: 90, recovery: 58, load: 121, tsb: 4 },
    { date: '07-19', hrv: 76, rhr: 44, sleepMin: 503, sleepScore: 99, recovery: 64, load: 68, tsb: 3.7 },
    { date: '07-20', hrv: 65, rhr: 45, sleepMin: 224, sleepScore: 51, recovery: 27, load: 47, tsb: 5.9 },
    { date: '07-21', hrv: 73, rhr: 43, sleepMin: 524, sleepScore: 97, recovery: 62, load: null, tsb: 13.3 },
  ],
  patterns: [
    { icon: '😴', title: 'Il sonno è la leva #1', text: 'Qualità del sonno ↔ recupero r=+0,77. Notti <7h → recupero medio 32; notti ≥8h → 54. Saltare una notte ti costa più di un allenamento duro.' },
    { icon: '🏋️', title: 'Il carico conta, ma meno', text: 'Carico di oggi → HRV di domani r=−0,35. Effetto reale ma secondario rispetto al sonno.' },
    { icon: '❤️', title: 'La FC a riposo è il 2° termometro', text: 'RHR ↔ HRV r=−0,84. Quando la RHR sale di 4-5 bpm sopra il tuo 43-45, è stress da prendere sul serio.' },
    { icon: '⚖️', title: 'Occhio a ACWR e monotonia', text: 'Il 4-9 lug ACWR salì a 1,5 (troppo in fretta) e la monotonia a 2,0 (troppo uguale). Auto-corretti. Sono i due segnali da tenere d\'occhio quando accumuli.' },
  ],
};

window.TRAINING = { RACE, ATHLETE, STATIONS, WEEK, WEEK_ARCHIVE, PBS, VOLUME, VOL_ROWER, VOL_SKI, VOL_RUN, VOL_BIKE, TOTALS, EF_TREND, HISTORY, HYDRATION, RECOVERY };
